...
import Row from './Row';
import type {RowProps, SelectedRows} from './types';
...
export default class Body extends React.PureComponent {
    ...
    cloneRows = (originalRows: Element<Row>) => {
    ...
    createCells = (cells: Element<Cell>, rowProps: RowProps, rowIndex: number) => {
        const {
            controls,
        } = this.props;
    ...
    cloneCells = (originalCells: Element<Cell>, rowIndex: number, cellIndex: number = 0) => {
