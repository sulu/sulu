...
class PageControllerTest extends SuluTestCase
{
    ...
    {
        static::jsonRequest($this->client, 'GET', '/api/pages?locale=en&flat=true');
    ...
    {
        static::jsonRequest($this->client, 'GET', '/api/pages?locale=en&flat=true&webspace=sulu_io');
        $this->assertHttpStatusCode(200, $this->client->getResponse());
    ...
    public function testGetFlatResponseWithParentAndWithoutWebspace()
    {
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages?locale=en&flat=true&parentId=' . $webspaceUuid);
        $this->assertHttpStatusCode(200, $this->client->getResponse());
    ...
    public function testGetFlatResponseWithIds()
    {
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages?locale=en&flat=true&ids=' . \implode(',', $webspaceUuids));
    ...
    public function testGetFlatResponseWithShadowAndGhostContent()
    {
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages?locale=de&flat=true&webspace=sulu_io');
        $response = \json_decode($this->client->getResponse()->getContent());
    ...
    public function testGetWithPermissions()
    {
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages/' . $securedPage->getUuid() . '?language=en&webspace=sulu_io');
    ...
    public function testSmallResponse()
    {
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages/' . $data[0]['id'] . '?webspace=sulu_io&language=en&complete=false');
    ...
    public function testGet()
    {
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages/' . $document->getUuid() . '?language=en');
        $response = \json_decode($this->client->getResponse()->getContent(), true);
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages/' . $document->getUuid() . '?language=de');
        $response = \json_decode($this->client->getResponse()->getContent(), true);
    ...
    public function testGetAnotherTemplate()
    {
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages/' . $document->getUuid() . '?language=en&template=default');
        $response = \json_decode($this->client->getResponse()->getContent(), true);
    ...
    {
        static::jsonRequest($this->client, 'GET', '/api/pages/not-existing-id?language=en');
        $this->assertHttpStatusCode(404, $this->client->getResponse());
    }

    public function testGetNotExistingTree()
    {
        static::jsonRequest($this->client, 'GET', '/api/pages?expandedIds=not-existing-id&webspace=sulu_io&language=en&fields=title,order,published');
        $this->assertHttpStatusCode(404, $this->client->getResponse());
    }
    ...
    public function testGetGhostContent()
    {
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages/' . $document->getUuid() . '?language=de&ghost-content=true');
        $response = \json_decode($this->client->getResponse()->getContent(), true);
    ...
    public function testGetInternalLink()
    {
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages/' . $internalLinkPage->getUuid() . '?webspace=sulu_io&language=en');
        $response = \json_decode($this->client->getResponse()->getContent(), true);
    ...
    public function testGetExternalLink()
    {
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages/' . $externalLinkPage->getUuid() . '?webspace=sulu_io&language=en');
        $response = \json_decode($this->client->getResponse()->getContent(), true);
    ...
    public function testDelete()
    {
        ...
        static::jsonRequest($this->client, 'DELETE', '/api/pages/' . $data[0]['id'] . '?webspace=sulu_io&language=en');
        $this->assertHttpStatusCode(204, $this->client->getResponse());

        static::jsonRequest($this->client, 'GET', '/api/pages/' . $data[0]['id'] . '?webspace=sulu_io&language=en');
        $this->assertHttpStatusCode(404, $this->client->getResponse());
    }
    ...
    public function testPut()
    {
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages/' . $response['id'] . '?language=de');
        $response = \json_decode($this->client->getResponse()->getContent(), true);
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages/' . $response['id'] . '?language=en');
        $response = \json_decode($this->client->getResponse()->getContent(), true);
    ...
    public function testPutAndPublish()
    {
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages/' . $data[0]['id'] . '?language=en');
    ...
    public function testPutHomeWithChildren()
    {
        ...
        static::jsonRequest($this->client, 'POST', '/api/pages?parentId=' . $homeDocument->getUuid() . '&webspace=sulu_io&language=en', $data);
        $this->assertHttpStatusCode(200, $this->client->getResponse());
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages?webspace=sulu_io&language=en');
        $response = \json_decode($this->client->getResponse()->getContent());
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages/' . $homepage->id . '?webspace=sulu_io&language=en');
    ...
    {
        static::jsonRequest($this->client, 'PUT', '/api/pages/not-existing-id?language=de', []);
        $this->assertHttpStatusCode(404, $this->client->getResponse());
    }
    ...
    public function testPutShadow()
    {
        ...
        static::jsonRequest($this->client, 'PUT', '/api/pages/' . $response['id'] . '?webspace=sulu_io&language=de', $data);
        static::jsonRequest($this->client,
            'PUT',
            '/api/pages/' . $response['id'] . '?webspace=sulu_io&language=de',
    ...
    public function testPutWithValidHash()
    {
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages/' . $response['id'] . '?language=en', $data);
        $response = \json_decode($this->client->getResponse()->getContent(), true);
    ...
    public function testHistory()
    {
        ...
        static::jsonRequest($this->client, 'PUT', '/api/pages/' . $uuid . '?webspace=sulu_io&language=en&action=publish', $data);
        $data = [
            'title' => 'news',
            'template' => 'default',
            'tags' => [
    ...
    public function testOrder()
    {
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages?fields=title,order&webspace=sulu_io&language=de');
        $this->assertHttpStatusCode(200, $this->client->getResponse());
        $response = \json_decode($this->client->getResponse()->getContent(), true);
        $homepage = $response['_embedded']['pages'][0];
    ...
    public function testNavContexts()
    {
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages/' . $data['id'] . '?webspace=sulu_io&language=en');
        $this->assertHttpStatusCode(200, $this->client->getResponse());
        $response = \json_decode($this->client->getResponse()->getContent(), true);
    ...
    public function testInternalLinkAutoName()
    {
        ...
        $data[0] = \json_decode($this->client->getResponse()->getContent(), true);
        static::jsonRequest($this->client, 'POST', '/api/pages?webspace=sulu_io&language=en&parentId=' . $data[0]['id'], $data[1]);
        $data[1] = \json_decode($this->client->getResponse()->getContent(), true);

        $data[0]['internalLinks'][] = $data[1]['id'];
        static::jsonRequest($this->client, 'PUT', '/api/pages/' . $data[0]['id'] . '?webspace=sulu_io&language=en', $data[0]);
        $data[0] = \json_decode($this->client->getResponse()->getContent(), true);
    ...
    public function testRenamePageWithLinkedChild()
    {
        ...
        static::jsonRequest($this->client, 'GET', '/api/pages/' . $document->getUuid() . '?webspace=sulu_io&language=en');
        $data = \json_decode($this->client->getResponse()->getContent(), true);
    ...
    public function testDeleteReferencedNode()
    {
        ...
        static::jsonRequest($this->client, 'DELETE', '/api/pages/' . $linkedDocument->getUuid() . '?webspace=sulu_io&language=en');
        $this->assertHttpStatusCode(409, $this->client->getResponse());
        $response = \json_decode($this->client->getResponse()->getContent(), true);
        ...
        static::jsonRequest($this->client, 'DELETE', '/api/pages/' . $linkedDocument->getUuid() . '?webspace=sulu_io&language=en&force=true');
        $this->assertHttpStatusCode(204, $this->client->getResponse());

        static::jsonRequest($this->client, 'GET', '/api/pages/' . $linkedDocument->getUuid() . '?webspace=sulu_io&language=en');
        $this->assertHttpStatusCode(404, $this->client->getResponse());
    }
