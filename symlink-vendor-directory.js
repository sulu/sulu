...
// is not an ancestor of the vendor/sulu/sulu directory. for example, npm 7 does not install the dependencies of the
// bundle packages (https://github.com/npm/cli/issues/2339) and older npm versions are not able to dedupe packages that
// are required by a bundle and in the assets/admin directory.
...
//
// to prevent these errors, this file creates a assets/admin/node_modules/node_modules/@sulu/vendor symlink and use
// the symlink to require the sulu bundles in the assets/admin/package.json. this makes the vendor directory a child
// of the assets/admin directory and allows npm to correctly dedupe the installed packages.
