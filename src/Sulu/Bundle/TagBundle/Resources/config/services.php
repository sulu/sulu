...
return static function(ContainerConfigurator $container) {
    ...
    $services->set('sulu_tag.admin', \Sulu\Bundle\TagBundle\Admin\TagAdmin::class)
        ->args([
    ...
    $services->set('sulu_tag.tag_manager', \Sulu\Bundle\TagBundle\Tag\TagManager::class)
        ->public()
        ->args([
    ...
    $services->set('sulu_tag.tag_request_handler', \Sulu\Component\Tag\Request\TagRequestHandler::class)
        ->args([service('request_stack')]);

    $services->set('sulu_tag.twig_extension', \Sulu\Bundle\TagBundle\Twig\TagTwigExtension::class)
        ->args([
            service('sulu.repository.tag'),
    ...
    $services->set('sulu_tag.tag_controller', \Sulu\Bundle\TagBundle\Controller\TagController::class)
        ->public()
        ->args([
