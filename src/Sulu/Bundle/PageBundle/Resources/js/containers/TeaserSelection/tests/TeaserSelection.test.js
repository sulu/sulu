...
const renderTeaserSelection = (customProps: Object = {}) => {
    ...
    const teaserSelectionRef = React.createRef();
    const view = render(<TeaserSelection {...props} ref={teaserSelectionRef} />);
    ...
    return {
        ...
        setProps: (newProps: Object) => {
            ...
            view.rerender(<TeaserSelection {...props} ref={teaserSelectionRef} />);
        },
    };
};
...
test('Render loading teaser selection', () => {
    ...
    const teaserSelection = renderTeaserSelection({value});

    expect(teaserSelection.asFragment()).toMatchSnapshot();
});
...
test('Render teaser selection with presentations', () => {
    ...
    const teaserSelection = renderTeaserSelection({
        presentations,
        value,
    });
