...
<comment>Usage:</>
  ...
  $ php ./bin/runtests.php -i -a             <comment># initialize and run all tests</>
  $ php ./bin/runtests.php -t LocationBundle <comment># run only LocationBundle tests</>
  $ php ./bin/runtests.php -f"--debug"       <comment># pass flags to PHPUnit</>
