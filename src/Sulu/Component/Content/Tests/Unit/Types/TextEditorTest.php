...
class TextEditorTest extends TestCase
{
    ...
    {
        $content = <<<'EOT'
<sulu:link href="123">Hello Hikaro Sulu</sulu:createLinkPlugin>
EOT;
...
EOT
    ...
    {
        $content = <<<'EOT'
<sulu:link href="123">Hello</sulu:createLinkPlugin>
<sulu:link href="456">Hikaro</sulu:createLinkPlugin>
<sulu:link href="789">Sulu</sulu:createLinkPlugin>
EOT;
        ...
        $this->markupParser->validate($content, 'de')->willReturn(
            [
                '<sulu:link href="123">Hello</sulu:createLinkPlugin>' => self::VALIDATE_REMOVED,
                '<sulu:link href="789">Sulu</sulu:createLinkPlugin>' => self::VALIDATE_UNPUBLISHED,
            ]
        );

        $this->property->setValue(
            <<<'EOT'
<sulu:link href="123" sulu:validation-state="removed">Hello</sulu:createLinkPlugin>
<sulu:link href="456">Hikaro</sulu:createLinkPlugin>
<sulu:link href="789" sulu:validation-state="unpublished">Sulu</sulu:createLinkPlugin>
EOT
        )->shouldBeCalled();
