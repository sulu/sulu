...
ALTER TABLE co_account_emails DROP FOREIGN KEY `FK_A3FBB24A996BB4F7`;
ALTER TABLE co_account_emails ADD CONSTRAINT `FK_A3FBB24A996BB4F7` FOREIGN KEY (`idAccounts`) REFERENCES `co_accounts` (`id`) ON DELETE CASCADE;
