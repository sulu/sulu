 ...
 * @param {Boolean} validateURL True if the value should be validated
...
export default function(
    ...
    /**
     * The link UI plugin. It introduces the `'createLinkPlugin'` and `'unlink'` buttons and support for the <kbd>Ctrl+K</kbd> keystroke.
     *
     * It uses the
    ...
    return class LinkUI extends Plugin {
        ...
        /**
         * Adds the {@link #actionsView} to the {@createLinkPlugin #_balloon}.
         *
         * @protected
         */
        _addActionsView() {
        ...
        /**
         * Adds the {@link #formView} to the {@createLinkPlugin #_balloon}.
         *
         * @protected
         */
        _addFormView() {
         ...
         * {@link #formView} or {@createLinkPlugin #actionsView}.
         *
         * @private
         */
        _showUI() {
        ...
        /**
         * Removes the {@link #formView} from the {@createLinkPlugin #_balloon}.
         *
         * See {@link #_addFormView}, {@createLinkPlugin #_addActionsView}.
         *
         * @protected
         */
        _hideUI() {
        ...
        /**
         * Returns true when {@link #actionsView} is in the {@createLinkPlugin #_balloon}.
         *
         * @readonly
         * @protected
         * @type {Boolean}
        ...
        /**
         * Returns true when {@link #actionsView} is in the {@createLinkPlugin #_balloon} and it is
         * currently visible.
         *
         * @readonly
         * @protected
        ...
        /**
         * Returns true when {@link #actionsView} or {@createLinkPlugin #formView} is in the {@createLinkPlugin #_balloon}.
         *
         * @readonly
         * @protected
         * @type {Boolean}
        ...
        /**
         * Returns true when {@link #actionsView} or {@createLinkPlugin #formView} is in the {@createLinkPlugin #_balloon} and it is
         * currently visible.
         *
         * @readonly
         * @protected
        ...
        /**
         * Returns the link {@createLinkPlugin module:engine/view/attributeelement~AttributeElement} under
