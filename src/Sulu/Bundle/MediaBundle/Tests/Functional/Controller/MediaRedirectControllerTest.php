...
class MediaRedirectControllerTest extends SuluTestCase
{
    ...
    public function testRedirect()
    {
        ...
        static::jsonRequest($this->client, 'GET', '/redirect/media/' . $media->getId() . '?locale=en-gb');
    ...
    public function testRedirectFormat()
    {
        ...
        static::jsonRequest($this->client, 'GET', '/redirect/media/' . $media->getId() . '?locale=en-gb&format=sulu-50x50');
