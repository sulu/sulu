...
/**
 * Compiler to create flysystem storage and add storage to the manager.
 */
class StorageCompilerPass implements CompilerPassInterface
{
    ...
    protected function getStorageDefinition(
        ...
        // as the config don't know which parameter is which argument in the construct
        // we need to loop through all arguments to replace the correct one.
