...
class MediaControllerTest extends SuluTestCase
{
    ...
    public function testGetByIdWithFallback()
    {
        ...
        static::jsonRequest($this->client, 'GET', '/api/media/' . $media->getId() . '?locale=de');
    ...
    public function testDeleteById()
    {
        ...
        static::jsonRequest($this->client, 'DELETE', '/api/media/' . $mediaId);
    ...
    public function testDeleteCollection()
    {
        ...
        static::jsonRequest($this->client, 'DELETE', '/api/collections/' . $this->collection->getId());
        $this->assertHttpStatusCode(204, $this->client->getResponse());
    ...
    public function testDeleteByIdNotExisting()
    {
        ...
        static::jsonRequest($this->client, 'DELETE', '/api/media/404');
        $this->assertHttpStatusCode(404, $this->client->getResponse());

        static::jsonRequest($this->client, 'GET', '/api/media?locale=en-gb');
        $response = \json_decode($this->client->getResponse()->getContent());
        $this->assertEquals(1, $response->total);
    }
    ...
    public function testMoveNonExistingCollection()
    {
        ...
        static::jsonRequest($this->client, 'POST', '/api/media/' . $media->getId() . '?action=move&destination=404');
    ...
    {
        static::jsonRequest($this->client, 'POST', '/api/media/404?locale=en-gb&action=move&destination=' . $this->collection->getId());
    ...
    public function testMoveNonExistingAction()
    {
        ...
        static::jsonRequest($this->client, 'POST', '/api/media/' . $media->getId() . '?action=test');
