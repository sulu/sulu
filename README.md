...
Sulu 2.6 requires a **PHP version higher or equal to 8.2** and is compatible with every **Symfony version 5.4 - 7.4**. Have a look at the `require` section in the [composer.json](composer.json) of the [sulu/sulu](https://github.com/sulu/sulu/tree/2.6) core framework to find an **up-to-date list of the requirements** of Sulu content management system.
