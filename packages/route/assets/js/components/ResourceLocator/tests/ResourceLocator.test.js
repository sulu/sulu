...
test('ResourceLocator should render with type full and a value of undefined', () => {
    ...
    const locale = observable.box('en');
    const {asFragment} = render(
        <ResourceLocator locale={locale} mode="tree_full_edit" onBlur={jest.fn()} onChange={onChange} value={undefined} />
    );
...
test('ResourceLocator should render with type leaf and a value of undefined', () => {
    ...
    const locale = observable.box('en');
    const {asFragment} = render(
        <ResourceLocator locale={locale} mode="tree_leaf_edit" onBlur={jest.fn()} onChange={onChange} value={undefined} />
    );
...
test('ResourceLocator should call the onBlur callback when the Input finishes editing', () => {
    ...
    const locale = observable.box('en');
    render(<ResourceLocator locale={locale} mode="tree_leaf_edit" onBlur={finishSpy} onChange={jest.fn()} value="/some/url" />);
