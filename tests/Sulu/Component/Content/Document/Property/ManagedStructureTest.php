...
class ManagedStructureTest extends \PHPUnit_Framework_TestCase
{
    public function setUp()
    {
        ...
        $this->inspector->getStructure($this->document->reveal())->willReturn($this->structureMetadata->reveal());
    }
    ...
    private function doGetProperty($name, $contentTypeName, $locale)
    {
        ...
        $this->structureMetadata->getProperty($name)->willReturn($this->structureProperty);
