...
### Using DateTimeImmutable for database columns
...
```sql
ALTER TABLE pa_pages CHANGE created created DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', CHANGE changed changed DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)';
ALTER TABLE sn_snippets CHANGE created created DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', CHANGE changed changed DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)';
ALTER TABLE ar_articles CHANGE created created DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)', CHANGE changed changed DATETIME NOT NULL COMMENT '(DC2Type:datetime_immutable)';
