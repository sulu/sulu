...
define(['type/default'], function(Default) {
    ...
    return function($el, options) {
        var defaults = {},
            ...
            subType = {
                initializeSub: function() {
                    var dataChangedEvent = 'sulu.customer-selection.' + options.instanceName + '.data-changed';
                ...
                setValue: function(value) {
                    App.dom.data($el, 'customer-selection', value);
                },

                getValue: function() {
                    return App.dom.data($el, 'customer-selection');
                },
        ...
        return new Default($el, defaults, options, 'customerSelection', subType);
    };
});
