...
class DeleteDependantsDialog extends React.Component<Props> {
    ...
    @observable showSnackbarError: boolean = true;
    ...
    render() {
        ...
        return (
            <Dialog
                ...
                error={this.error && this.showSnackbarError ? this.error : undefined}
                onCancel={
                    this.errored || this.cancelled || this.finished
                        ? this.handleClose
                        : this.handleCancel
                ...
                warning={this.cancelled && this.showSnackbarError
                    ? translate('sulu_admin.delete_dependants_cancelled_text')
                    : undefined
                }
            >
