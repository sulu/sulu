    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode->children()
            ...
            ->arrayNode('format_cache')
                ->addDefaultsIfNotSet()
                ->children()
                    ->scalarNode('private_path')->defaultValue('%kernel.project_dir%/var/media/formats')->end()
            ...
            ->arrayNode('routing')
                ...
                ->children()
                    ...
                    ->scalarNode('media_proxy_path_private_admin')->defaultValue('/admin/media/formats/{slug}')->end()
                    ->scalarNode('media_download_path_private_admin')->defaultValue('/admin/media/{id}/download/{slug}')->end()
                ->end()
            ->end()
            ->arrayNode('ffmpeg')
                ->children()
