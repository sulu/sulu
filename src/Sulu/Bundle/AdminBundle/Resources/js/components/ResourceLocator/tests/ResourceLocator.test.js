...
test('ResourceLocator should render with type full and a value of undefined', () => {
    ...
    const locale = observable.box('en');
    const {asFragment} = render(
        <ResourceLocator locale={locale} mode="full" onBlur={jest.fn()} onChange={onChange} value={undefined} />
    );
...
test('ResourceLocator should render with type leaf and a value of undefined', () => {
    ...
    const locale = observable.box('en');
    const {asFragment} = render(
        <ResourceLocator locale={locale} mode="leaf" onBlur={jest.fn()} onChange={onChange} value={undefined} />
    );
...
test('ResourceLocator should update the split leaf representation when value changes', () => {
    ...
    const {container, rerender} = render(
        <ResourceLocator locale={locale} mode="leaf" onBlur={jest.fn()} onChange={onChange} value="/child" />
    );
...
test('ResourceLocator should call the onChange callback with undefined if no input is given', () => {
    const onChange = jest.fn();
    const locale = observable.box('en');
    render(<ResourceLocator locale={locale} mode="leaf" onChange={onChange} value="/url" />);
