...
return static function(ContainerConfigurator $container) {
    ...
    $services->set('sulu_audience_targeting.content.type.target_group_selection', TargetGroupSelection::class)
        ->args([new Reference('sulu.repository.target_group')])
        ->tag('sulu.content.type', ['alias' => 'target_group_selection'])
