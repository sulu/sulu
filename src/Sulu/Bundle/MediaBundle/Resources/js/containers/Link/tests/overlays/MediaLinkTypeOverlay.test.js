...
test('Render overlay with invalid href type', () => {
    const mediaLinkTypeOverlay = new MediaLinkTypeOverlay(createProps({href: '1234'}));

    expect(() => mediaLinkTypeOverlay.render()).toThrow('The id of a media should always be a number!');
});
