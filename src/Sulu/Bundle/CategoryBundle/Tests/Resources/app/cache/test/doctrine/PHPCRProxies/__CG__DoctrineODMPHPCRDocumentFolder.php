 ...
 */
class Folder extends \Doctrine\ODM\PHPCR\Document\Folder implements \Doctrine\Common\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'children', 'child', 'id', 'node', 'nodename', 'parent', 'created', 'createdBy');
        }
     ...
     * {@inheritDoc}
     */
    public function addChild(\Doctrine\ODM\PHPCR\HierarchyInterface $child)
    {
