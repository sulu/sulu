...
namespace Sulu\Bundle\ContentBundle\Tests\Functional\ResourceLocator\Strategy;
...
class TreeFullEditStrategyTest extends SuluTestCase
{
    ...
    {
        $this->resourceLocatorStrategy = $this->getContainer()->get('sulu_content.sulu.content.resource_locator.strategy.tree_full_edit');
