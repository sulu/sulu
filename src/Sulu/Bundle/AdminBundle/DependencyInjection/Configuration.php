        ...
        $treeBuilder->getRootNode()
            ->children()
                ...
                ->arrayNode('ckeditor')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->arrayNode('text_part_languages')
                            ->info('The languages offered to mark parts of a text, defaults to the languages of all webspace localizations')
                            ->scalarPrototype()
                                ->validate()
                                    ->ifTrue(function($value) {
                                        return !\is_string($value) || !\preg_match('/^[a-z]{2,3}$/', $value);
                                    })
                                    ->thenInvalid('The text part language %s must be a language code without a country, e.g. "de"')
                                ->end()
                            ->end()
                        ->end()
                    ->end()
