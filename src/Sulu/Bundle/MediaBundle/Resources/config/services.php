...
return static function(ContainerConfigurator $container) {
    ...
    $services->alias('Sulu\Bundle\MediaBundle\FileInspector\SvgSafetyInspectorInterface::class', 'sulu_media.file_inspector.svg_inspector');
    ...
    $services->set('sulu_media.admin_media_reindex_provider', AdminMediaReindexProvider::class)
        ->args([
            new Reference('doctrine.orm.entity_manager'),
            tagged_iterator('sulu_media.admin_media_reindex_provider_enhancer'),
        ])
