...
class Account extends ApiEntity
{
    ...
    /**
     * Returns the billing address of an account
     ...
     * @return mixed
     */
    public function getBillingAddress($force = false)
    {
        /** @var Address $address */
        $conditionCallback = function($address) {
            return $address->getBillingAddress();
        };
        return $this->getAddressByCondition($conditionCallback, $force);
    }
     ...
     * @return mixed
     */
    public function getDeliveryAddress($force = false)
    {
        /** @var Address $address */
        $conditionCallback = function($address) {
     ...
     * @return mixed
     */
    private function getAddressByCondition(callable $conditionCallback, $force = false)
    {
        $accountAddresses = $this->getAccountAddresses();
        $address = null;
        $main = null;
