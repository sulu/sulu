...
| multipledeleteinfo_account         | sulu_contact.get_account_contacts                    |
| get_account_contacts               | sulu_contact.get_account_addresses                   |
| get_account_addresses              | sulu_contact.put_account_contacts                    |
| put_account_contacts               | sulu_contact.delete_account_contacts                 |
| delete_account_contacts            | sulu_contact.get_accounts                            |
| get_accounts                       | sulu_contact.post_account                            |
| post_account                       | sulu_contact.put_account                             |
| put_account                        | sulu_contact.patch_account                           |
| patch_account                      | sulu_contact.delete_account                          |
| delete_account                     | sulu_contact.multipledeleteinfo_account              |
...
| cget_account_medias                | sulu_contact.delete_account_medias                   |
| delete_account_medias              | sulu_contact.post_account_medias                     |
| post_account_medias                | sulu_contact.cget_account_medias                     |
| get_account_medias                 | sulu_contact.get_account_medias                      |
| cget_contact_medias                | sulu_contact.delete_contact_medias                   |
| delete_contact_medias              | sulu_contact.post_contact_medias                     |
| post_contact_medias                | sulu_contact.cget_contact_medias                     |
...
| index_node                         | sulu_page.get_node                                   |
| get_node                           | sulu_page.index_node                                 |
...
| entry_page                         | sulu_page.get_pages                                  |
| index_page                         | sulu_page.post_page_trigger                          |
| get_pages                          | sulu_page.entry_page                                 |
| post_page_trigger                  | sulu_page.get_page                                   |
| get_page                           | sulu_page.index_page                                 |
...
| cget_media                         | sulu_media.get_media                                 |
| get_media                          | sulu_media.cget_media                                |
...
| cdelete_webspace_analytics         | sulu_website.get_webspace_analytics                  |
| get_webspace_analytics             | sulu_website.post_webspace_analytics                 |
| post_webspace_analytics            | sulu_website.put_webspace_analytics                  |
| put_webspace_analytics             | sulu_website.delete_webspace_analytics               |
| delete_webspace_analytics          | sulu_website.cdelete_webspace_analytics              |
| get_localizations                  | sulu_core.get_localizations                          |
| cget_webspace_custom-urls          | sulu_custom_url.cget_webspace_custom-urls            |
| cdelete_webspace_custom-urls       | sulu_custom_url.get_webspace_custom-urls             |
| get_webspace_custom-urls           | sulu_custom_url.post_webspace_custom-urls            |
| post_webspace_custom-urls          | sulu_custom_url.put_webspace_custom-urls             |
| put_webspace_custom-urls           | sulu_custom_url.delete_webspace_custom-urls          |
| delete_webspace_custom-urls        | sulu_custom_url.cdelete_webspace_custom-urls         |
