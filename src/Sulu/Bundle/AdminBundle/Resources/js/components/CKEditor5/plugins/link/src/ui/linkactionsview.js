 ...
 */
export default function(tag, attributeName, validateURL = false) {
    /**
    ...
    return class LinkActionsView extends View {
        ...
        constructor(locale) {
            ...
            /**
             * Value of the "href" attribute of the link to use in the {@createLinkPlugin #previewButtonView}.
             *
             * @observable
             * @member {String}
             */
        ...
        _createPreviewButton() {
            ...
            button.bind('label').to(this, 'href', (value) => {
                return (value && value.value) || t('This link has no URL');
            });

            button.bind('isEnabled').to(this, 'href', (value) => !!(value && value.value));
