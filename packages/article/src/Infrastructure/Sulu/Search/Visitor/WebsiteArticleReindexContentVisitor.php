...
/**
 * @internal if you need to override this service, create a new service based on the WebsiteArticleReindexProviderVisitorInterface
 * instead of extending this class
 *
 * @final
 */
class WebsiteArticleReindexContentVisitor implements WebsiteArticleReindexProviderVisitorInterface
{
