...
const BASELINE = [
    'packages/custom-url/assets/js/containers/Form/tests/fields/CustomUrl.test.js',
    'packages/custom-url/assets/js/containers/Form/tests/fields/CustomUrlsDomainSelect.test.js',
    'packages/custom-url/assets/js/containers/Form/tests/fields/CustomUrlsLocaleSelect.test.js',
    'packages/page/assets/js/containers/Form/tests/fields/PageSettingsNavigationSelect.test.js',
    'packages/page/assets/js/containers/Form/tests/fields/PageSettingsShadowLocaleSelect.test.js',
    'packages/page/assets/js/containers/Form/tests/fields/PageTreeRoute.test.js',
    'packages/page/assets/js/containers/Form/tests/fields/SearchResult.test.js',
    'packages/page/assets/js/containers/Form/tests/fields/SegmentSelect.test.js',
    'packages/page/assets/js/containers/Form/tests/fields/SettingsVersions.test.js',
    'packages/page/assets/js/containers/Form/tests/fields/TeaserSelection.test.js',
    'packages/page/assets/js/containers/SegmentSelect/tests/SegmentSelect.test.js',
    'packages/page/assets/js/containers/TeaserSelection/tests/Item.test.js',
    'packages/page/assets/js/containers/TeaserSelection/tests/TeaserSelection.test.js',
    'packages/page/assets/js/views/PageList/tests/PageList.test.js',
    'packages/page/assets/js/views/PageTabs/tests/PageTabs.test.js',
    'packages/page/assets/js/views/WebspaceTabs/tests/WebspaceTabs.test.js',
    'packages/route/assets/js/containers/Form/tests/fields/ResourceLocator.test.js',
    'packages/route/assets/js/containers/ResourceLocatorHistory/tests/ResourceLocatorHistory.test.js',
    'packages/search/assets/js/containers/Search/tests/Search.test.js',
    'packages/search/assets/js/containers/Search/tests/SearchField.test.js',
    'packages/search/assets/js/containers/Search/tests/SearchResult.test.js',
    'packages/search/assets/js/views/Search/tests/Search.test.js',
    'packages/snippet/assets/js/views/SnippetAreas/tests/SnippetAreas.test.js',
    ...
    'src/Sulu/Bundle/AdminBundle/Resources/js/views/AuthorizationConsent/tests/AuthorizationConsent.test.js',
    ...
    'src/Sulu/Bundle/AdminBundle/Resources/js/views/List/tests/itemActions/RestoreVersionItemAction.test.js',
...
const SCAN_DIRECTORIES = ['packages', 'src', 'tests'];
