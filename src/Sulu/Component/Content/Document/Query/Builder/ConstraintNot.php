...
/**
 * @see Doctrine\ODM\PHPCR\Query\Builder\ConstraintNot
 */
class ConstraintNot extends ConstraintFactory implements SuluNodeInterface
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return QueryBuilderUtil::addNodeChildren($this, new Doctrine\ConstraintNot($this->getParent()));
    }
}
