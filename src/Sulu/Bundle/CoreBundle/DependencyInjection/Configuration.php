...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode = $treeBuilder->root('sulu');
                        ...
                        ->arrayNode('types')
                            ...
                            ->children()
                                ->arrayNode('text_line')
                                    ...
                                    ->children()
                                        ->scalarNode('template')
                                            ->defaultValue('SuluContentBundle:Template:content-types/textLine.html.twig')
                                        ->end()
                                    ->end()
                                ->end()
                                ->arrayNode('text_area')
                                    ...
                                    ->children()
                                        ->scalarNode('template')
                                            ->defaultValue('SuluContentBundle:Template:content-types/textArea.html.twig')
                                        ->end()
                                    ->end()
                                ->end()
