            ...
            ->children()
                ->arrayNode('user_context')
                    ...
                    ->children()
                        ...
                        ->scalarNode('url')->defaultValue(HttpCache::USER_CONTEXT_URI)->end()
                        ->arrayNode('cookies')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('target_group')->defaultValue(HttpCache::USER_CONTEXT_COOKIE)->end()
                                ->scalarNode('session')->defaultValue(HttpCache::USER_CONTEXT_SESSION_COOKIE)->end()
                            ->end()
                        ->end()
                        ->arrayNode('hit')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('url')->defaultValue('/_user_context_hit')->end()
                                ->arrayNode('headers')
                                    ->addDefaultsIfNotSet()
                                    ->children()
