        ...
        var defaults = {},
            ...
            subType = {
                initializeSub: function() {
                    var dataChangedEvent = 'sulu.single-internal-link.' + options.instanceName + '.data-changed';
                ...
                setValue: function(value) {
                    App.dom.data($el, 'single-internal-link', value);
                },

                getValue: function() {
                    return App.dom.data($el, 'single-internal-link');
                },
