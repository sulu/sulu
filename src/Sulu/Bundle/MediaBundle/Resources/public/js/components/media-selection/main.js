        ...
        templates = {
            skeleton: function(options, positionClass) {
                return [
                    ...
                    '    <div class="top left ', (!options.displayOptions.middle ? 'inactive' : ''), '" data-position="leftTop"></div>',
                    '    <div class="top middle ', (!options.displayOptions.middle ? 'inactive' : ''), '" data-position="top"></div>',
                    '    <div class="top right ', (!options.displayOptions.middle ? 'inactive' : ''), '" data-position="rightTop"></div>',
                    '    <div class="middle left ', (!options.displayOptions.middle ? 'inactive' : ''), '" data-position="left"></div>',
                    '    <div class="middle middle ', (!options.displayOptions.middle ? 'inactive' : ''), '"></div>',
                    '    <div class="middle right ', (!options.displayOptions.middle ? 'inactive' : ''), '" data-position="right"></div>',
                    '    <div class="bottom left ', (!options.displayOptions.middle ? 'inactive' : ''), '" data-position="leftBottom"></div>',
                    '    <div class="bottom middle ', (!options.displayOptions.middle ? 'inactive' : ''), '" data-position="bottom"></div>',
                    '    <div class="bottom right ', (!options.displayOptions.middle ? 'inactive' : ''), '" data-position="rightBottom"></div>',
                    '</div>',
                    '       </div>',
