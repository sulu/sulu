...
class AdminControllerTest extends SuluTestCase
{
    ...
    public function testGetConfig(): void
    {
        ...
        $this->assertSame('en', $response->sulu_admin->localizations[0]->locale);
        $this->assertSame('en_us', $response->sulu_admin->localizations[1]->locale);
        $this->assertSame('de', $response->sulu_admin->localizations[2]->locale);
        $this->assertSame('de_at', $response->sulu_admin->localizations[3]->locale);
    }
