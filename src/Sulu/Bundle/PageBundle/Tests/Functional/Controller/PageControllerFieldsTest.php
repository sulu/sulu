...
class PageControllerFieldsTest extends SuluTestCase
{
    ...
    public function testCGet(): void
    {
        ...
        $this->client->jsonRequest('GET', '/api/pages?' . \http_build_query(['webspace' => 'sulu_io', 'language' => 'de', 'fields' => 'title']));
    ...
    public function testCGetExcludeShadow(): void
    {
        ...
        $this->client->jsonRequest(
            'GET',
            '/api/pages?' .
            \http_build_query(['webspace' => 'sulu_io', 'language' => 'de', 'fields' => 'title', 'exclude-shadows' => 'true'])
        );
    ...
    public function testCGetExcludeGhost(): void
    {
        ...
        $this->client->jsonRequest('GET', '/api/pages?webspace=sulu_io&language=de&fields=title&exclude-ghosts=true');
    ...
    public function testCGetExcludeGhostAndShadow(): void
    {
        ...
        $this->client->jsonRequest(
            'GET',
            '/api/pages?webspace=sulu_io&language=de&fields=title&exclude-ghosts=true&exclude-shadows=true'
        );
    ...
    public function testLinkedInternal(): void
    {
        ...
        $this->client->jsonRequest(
            'GET',
            \sprintf('/api/pages/%s', $page->getUuid()) . '?webspace=sulu_io&language=en&fields=title'
        );
        $result = \json_decode($this->client->getResponse()->getContent(), true);
    ...
    public function testTypeShadow(): void
    {
        ...
        $this->client->jsonRequest(
            'GET',
            \sprintf('/api/pages/%s', $page->getUuid()) . '?webspace=sulu_io&language=de&fields=title'
        );
        $result = \json_decode($this->client->getResponse()->getContent(), true);
