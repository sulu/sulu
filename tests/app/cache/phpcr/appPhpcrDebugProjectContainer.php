...
/**
 * appPhpcrDebugProjectContainer
 *
 * This class has been auto-generated
 * by the Symfony Dependency Injection Component.
 */
class appPhpcrDebugProjectContainer extends Container
{
    private $parameters;
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'sulu.content.localization_finder.null_webspace' => 'getSulu_Content_LocalizationFinder_NullWebspaceService',
            'sulu.content.localization_finder.parent_child_any' => 'getSulu_Content_LocalizationFinder_ParentChildAnyService',
            'sulu.content.mapper' => 'getSulu_Content_MapperService',
            'sulu.content.mapper.subscriber.node_order' => 'getSulu_Content_Mapper_Subscriber_NodeOrderService',
            ...
            'sulu.core.build.builder.node_order' => 'getSulu_Core_Build_Builder_NodeOrderService',
            ...
            'sulu_core.webspace.request_analyzer.admin' => 'getSuluCore_Webspace_RequestAnalyzer_AdminService',
            'sulu_core.webspace.request_analyzer.website' => 'getSuluCore_Webspace_RequestAnalyzer_WebsiteService',
        ...
        $this->aliases = array(
            ...
            'sulu_core.webspace.request_analyzer' => 'sulu_core.webspace.request_analyzer.admin',
        );
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('sulu.content.mapper.subscriber.node_order', 'Sulu\\Component\\Content\\Mapper\\Subscriber\\NodeOrderSubscriber');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addResolveTargetEntity('Sulu\\Component\\Security\\UserInterface', 'Sulu\\Bundle\\TestBundle\\Entity\\TestUser', array());
        $c->addResolveTargetEntity('Sulu\\Bundle\\SecurityBundle\\Entity\\RoleInterface', 'Sulu\\Bundle\\SecurityBundle\\Entity\\Role', array());

        $d = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this);
        $d->addEventListener(array(0 => 'loadClassMetadata'), $c);

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'dbname' => 'sulu_test', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'port' => NULL, 'driverOptions' => array()), $b, $d, array());
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Sulu\Component\Content\Mapper\LocalizationFinder\ChainFinder A Sulu\Component\Content\Mapper\LocalizationFinder\ChainFinder instance.
     */
    protected function getSulu_Content_LocalizationFinderService()
    {
        $this->services['sulu.content.localization_finder'] = $instance = new \Sulu\Component\Content\Mapper\LocalizationFinder\ChainFinder();

        $instance->addFinder($this->get('sulu.content.localization_finder.parent_child_any'));
        $instance->addFinder($this->get('sulu.content.localization_finder.null_webspace'));

        return $instance;
    }

    /**
     * Gets the 'sulu.content.localization_finder.null_webspace' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Sulu\Component\Content\Mapper\LocalizationFinder\NullWebspaceFinder A Sulu\Component\Content\Mapper\LocalizationFinder\NullWebspaceFinder instance.
     */
    protected function getSulu_Content_LocalizationFinder_NullWebspaceService()
    {
        return $this->services['sulu.content.localization_finder.null_webspace'] = new \Sulu\Component\Content\Mapper\LocalizationFinder\NullWebspaceFinder($this->get('sulu.util.node_helper'));
    }

    /**
     * Gets the 'sulu.content.localization_finder.parent_child_any' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSulu_Content_LocalizationFinder_ParentChildAnyService()
    {
        return $this->services['sulu.content.localization_finder.parent_child_any'] = new \Sulu\Component\Content\Mapper\LocalizationFinder\ParentChildAnyFinder($this->get('sulu_core.webspace.webspace_manager'), 'i18n', '');
    }
    ...
    {
        return $this->services['sulu.content.mapper'] = new \Sulu\Component\Content\Mapper\ContentMapper($this->get('sulu.content.type_manager'), $this->get('sulu.content.structure_manager'), $this->get('sulu.phpcr.session'), $this->get('debug.event_dispatcher'), $this->get('sulu.content.localization_finder'), $this->get('sulu.content.path_cleaner'), $this->get('sulu_core.webspace.webspace_manager'), new \Sulu\Component\Content\Template\TemplateResolver(), 'en', array('page' => 'default', 'snippet' => 'default'), 'i18n', '', $this->get('debug.stopwatch', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('sulu.util.node_helper'));
    }

    /**
     * Gets the 'sulu.content.mapper.subscriber.node_order' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Sulu\Component\Content\Mapper\Subscriber\NodeOrderSubscriber A Sulu\Component\Content\Mapper\Subscriber\NodeOrderSubscriber instance.
     */
    protected function getSulu_Content_Mapper_Subscriber_NodeOrderService()
    {
        return $this->services['sulu.content.mapper.subscriber.node_order'] = new \Sulu\Component\Content\Mapper\Subscriber\NodeOrderSubscriber();
    }
    ...
    /**
     * Gets the 'sulu.core.build.builder.node_order' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSulu_Core_Build_Builder_NodeOrderService()
    {
        return $this->services['sulu.core.build.builder.node_order'] = new \Sulu\Bundle\CoreBundle\Build\NodeOrderBuilder($this->get('sulu.phpcr.session'), $this->get('sulu_core.webspace.webspace_manager'));
    }
    ...
    {
        return $this->services['sulu.phpcr.session'] = new \Sulu\Component\PHPCR\SessionManager\SessionManager($this->get('doctrine_phpcr.default_session'), array('base' => 'cmf', 'content' => 'contents', 'route' => 'routes', 'temp' => 'temp', 'snippet' => 'snippets'));
    }
    ...
    {
        return $this->services['sulu.util.node_helper'] = new \Sulu\Component\Util\SuluNodeHelper('i18n');
    }
    ...
    /**
     * Gets the 'sulu_core.webspace.request_analyzer.admin' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Sulu\Component\Webspace\Analyzer\AdminRequestAnalyzer A Sulu\Component\Webspace\Analyzer\AdminRequestAnalyzer instance.
     */
    protected function getSuluCore_Webspace_RequestAnalyzer_AdminService()
    {
        return $this->services['sulu_core.webspace.request_analyzer.admin'] = new \Sulu\Component\Webspace\Analyzer\AdminRequestAnalyzer($this->get('sulu_core.webspace.webspace_manager'), 'phpcr');
    }

    /**
     * Gets the 'sulu_core.webspace.request_analyzer.website' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Sulu\Component\Webspace\Analyzer\WebsiteRequestAnalyzer A Sulu\Component\Webspace\Analyzer\WebsiteRequestAnalyzer instance.
     */
    protected function getSuluCore_Webspace_RequestAnalyzer_WebsiteService()
    {
        return $this->services['sulu_core.webspace.request_analyzer.website'] = new \Sulu\Component\Webspace\Analyzer\WebsiteRequestAnalyzer($this->get('sulu_core.webspace.webspace_manager'), 'phpcr');
    }
    ...
    {
        return $this->services['sulu_core.webspace.request_listener'] = new \Sulu\Component\Webspace\EventListener\RequestListener($this->get('sulu_core.webspace.request_analyzer.admin'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.container_class' => 'appPhpcrDebugProjectContainer',
            'sulu.context' => 'admin',
            ...
            'router.options.matcher.cache_class' => 'appPhpcrUrlMatcher',
            'router.options.generator.cache_class' => 'appPhpcrUrlGenerator',
            ...
            'sulu.content.node_names.temp' => 'temp',
            ...
            'sulu.content.structure.default_type.page' => 'default',
            ...
            'sulu.content.mapper.subscriber.node_order.class' => 'Sulu\\Component\\Content\\Mapper\\Subscriber\\NodeOrderSubscriber',
            ...
            'sulu.content.localization_finder.parent_child_any.class' => 'Sulu\\Component\\Content\\Mapper\\LocalizationFinder\\ParentChildAnyFinder',
            ...
            'sulu.core.build.builder.node_order.class' => 'Sulu\\Bundle\\CoreBundle\\Build\\NodeOrderBuilder',
