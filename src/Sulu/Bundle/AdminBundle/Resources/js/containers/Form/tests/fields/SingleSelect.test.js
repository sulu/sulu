...
jest.mock('../../../../components/SingleSelect', () => {
    const SingleSelectMock: any = jest.fn((props) => {
        ...
        return mockReact.createElement('select', {'aria-label': 'select', disabled: props.disabled}, props.children);
    });

    SingleSelectMock.Option = jest.fn((props) => {
        mockOptionProps.push(props);

        return mockReact.createElement('option', {value: props.value}, props.children);
    });
